...
public class ModifKafeDenganParameter12 {
    public static void tampilkanMenu(String namaPelanggan, boolean isMember, String kodePromo) {
    ...
    public static void main(String[] args) {
        tampilkanMenu("Andi", true, "DISKON50");
    }
}
